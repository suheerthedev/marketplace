...
// in marketplace/test/helpers/test_helpers.dart.
...
class MockProductService extends _i1.Mock implements _i7.ProductService {
  ...
  @override
  void addProduct(_i8.Product? product) => super.noSuchMethod(
        Invocation.method(
          #addProduct,
          [product],
        ),
  ...
  @override
  void removeProduct(String? id) => super.noSuchMethod(
        Invocation.method(
          #removeProduct,
          [id],
        ),
  ...
  @override
  List<_i8.Product> searchProducts(String? query) => (super.noSuchMethod(
        Invocation.method(
          #searchProducts,
          [query],
        ),
  ...
  @override
  void toggleSavedStatus(String? id) => super.noSuchMethod(
        Invocation.method(
          #toggleSavedStatus,
          [id],
        ),
